use crate::commands::git;
    ...
    use crate::commands::{
        ...
        vision_bridge as vision_bridge_commands, team as team_commands,
    ...
    pub fn run() {
        ...
        builder
            ...
            .setup(|app| {
                ...
                if app.get_webview_window("main").is_none() {
                    ...
                    let builder = tauri::WebviewWindowBuilder::new(app, "main", url)
                        ...
                        // Start hidden to avoid a white/empty flash while the
                        // webview loads. The frontend emits "main://ready"
                        // once the app shell mounts, which makes the window
                        // visible. If the event never fires (e.g. a JS error),
                        // a 15-second fallback timer shows it anyway.
                        .visible(false);
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                git::git_init,
                git::git_pull,
                git::git_start_pull_merge,
                git::git_has_merge_head,
                git::git_fetch,
                git::git_push_info,
                git::git_push,
                git::git_new_branch,
                ...
                git::git_is_tracked,
                git::git_diff,
                git::git_diff_with_branch,
                git::git_show_diff,
                git::git_show_file,
                git::git_commit,
                git::git_rollback_file,
                git::git_add_files,
                git::git_list_all_branches,
                ...
                git::git_conflict_file_versions,
                git::git_resolve_conflict,
                git::git_abort_operation,
                git::git_continue_operation,
                ...
                acp_commands::acp_diagnose_agent,
                acp_commands::acp_diagnose_all_agents,
                acp_commands::acp_repair_agent_config,
                acp_commands::acp_ensure_npm_path,
                ...
                acp_commands::acp_get_command_code_login_status,
                acp_commands::acp_start_command_code_login,
                acp_commands::acp_cancel_command_code_login,
                acp_commands::acp_logout_command_code,
                acp_commands::acp_start_native_login,
                acp_commands::acp_get_native_login_status,
                acp_commands::acp_cancel_native_login,
                acp_commands::acp_logout_native_login,
                acp_commands::acp_supports_native_login,
                ...
                team_commands::team_delegate_task,
                ...
                model_provider_commands::test_model_provider,
