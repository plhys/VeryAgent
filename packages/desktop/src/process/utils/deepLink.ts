...
export const PROTOCOL_SCHEME = 'veryagent';

/**
 * Parse an veryagent:// URL into action and params.
 * Supports two formats:
 *   1. veryagent://add-provider?base_url=xxx&api_key=xxx
 *   2. veryagent://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
