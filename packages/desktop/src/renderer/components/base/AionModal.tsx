...
const AionModal: React.FC<AionModalProps> = ({
  ...
  return (
    <Modal
      ...
      footer={null}
      onCancel={onCancel}
      className={`veryagent-modal ${className}`}
      style={finalStyle}
      getPopupContainer={() => document.body}
    >
      <div className='veryagent-modal-wrapper' style={{ borderRadius: borderRadiusVal }}>
        {renderHeader()}
        <div className='veryagent-modal-body-content' style={bodyInlineStyle}>
          {children}
        </div>
        {renderFooter()}
      </div>
