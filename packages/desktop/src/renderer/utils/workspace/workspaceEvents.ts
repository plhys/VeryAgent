export const WORKSPACE_TOGGLE_EVENT = 'veryagent-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'veryagent-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'veryagent-workspace-has-files';
