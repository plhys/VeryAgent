...
export const WORKSPACE_EXPANSION_STORAGE_KEY = 'veryagent_workspace_expansion';
export const WORKSPACE_EXPANSION_EVENT = 'veryagent:workspace-expansion-changed';
