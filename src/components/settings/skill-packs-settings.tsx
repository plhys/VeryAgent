 ...
 * veryAgent-managed skill bundles (Experts, Science, Office). Each tab renders
 * the existing per-pack body verbatim.
 */
export function SkillPacksSettings() {
  ...
  // All three packs link from ONE shared central store (~/.veryagent/skills), so a
