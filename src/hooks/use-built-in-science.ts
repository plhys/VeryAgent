...
// fetch. Science skills are bundled into the binary and change only when
// veryagent is upgraded, so refetching per mount is wasted work. Mirrors
...
/**
 * Returns the list of built-in scientific-research skills bundled into
 * veryAgent.
 *
