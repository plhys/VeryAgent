...
const EXACT_TOOL_NAME_ALIASES: Record<string, string> = {
  ...
  // Legacy veryagent namespace (backward compat for older sidecar builds)
  mcp__veryagent__delegate_to_agent: "delegate_to_agent",
